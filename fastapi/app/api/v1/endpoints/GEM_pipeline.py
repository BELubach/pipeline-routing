...
from app.schemas.pipeline import GEMPipelineSegmentDTO, GEMSegmentsResponse
...
async def get_pipeline_segments(
	...
	metadata = create_response_metadata(
		...
		total_records=limit if limit is not None and len(segments) == limit else None,
